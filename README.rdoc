...
* Browser mode:
    * For Chrome run command: bundle exec spinach
    * For Firefox run command: driver=firefox bundle exec spinach
...
PS: For setting up differnent browsers on local, see https://my.thoughtworks.com/groups/testing/blog/2014/11/27/cross-browser
